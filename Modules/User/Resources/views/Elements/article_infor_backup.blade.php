...
<article class="css-81mxb5">
    <header class="css-1a6wa7t">
        <div class="css-70qvj9">
            <a href="/<?php echo $post['username']; ?>" class="css-hqvexg">
                <img class="css-100alwu eyfquo10" src="<?php echo '/storage/'.$post['profile_photo_path']?>" width="20" height="20" loading="lazy">
            </a>
    ...
    <footer class="css-1t3oi0e">
        <div>
            ...
            <div class="css-70qvj9">
                <img src="{{URL::asset('/images/utils/like.svg')}}" alt="profile Pic" height="20" width="20" style="transform: translateY(-3px)">
