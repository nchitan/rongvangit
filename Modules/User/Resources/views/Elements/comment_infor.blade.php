          ...
          <article class="css-81mxb5">
            ...
            <div class="css-9v1ub6" >
                <a href="<?php echo '/'.$post ->username.'/posts/'.$post->item.'#comment-'.$post->id ;?>" class="css-13fpj8m">
            ...
            <h2 class="css-1fhgjcy">
                <a href="/<?php echo $post ->username; ?>/posts/<?php echo $post->item?>" class="css-1iomb4h"><?php echo $post->title?></a>
