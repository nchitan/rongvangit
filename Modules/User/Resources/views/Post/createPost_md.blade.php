...
<div class="css-1rnpb4k esnipul0">
    ...
    <div class="css-kav51v ed5758y0">
        ...
        <div class="search-input" style="position: absolute;">
            ...
            <input  id="tags" required placeholder="Nhập tối đa 5 Tag" name="tags" type="text" data-role="tagsinput" value="{{ old('tags') }}" >
        </div>
...
function publish(){
    ...
    document.forms["publishForm"].tags.value =$tag.join(',');
     ...
     // document.forms["publishForm"].tag.value = 'laravel, php';
