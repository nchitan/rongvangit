        ...
        <div class="css-cq4c1a">
            <div class="css-1x8nfy4">
                ...
                <?php 
                    if($posts[0]['countlike']){
                        ...
                        echo '<span class="css-8g69pl" style="color: #5f6161;">0</span>';
            ...
            <div class="css-tubf1g">
                ...
                <button class="<?php if(Auth::user()){echo 'css-1drc635';}else{echo 'css-1drc635 authbtn';} ?>" style="border:none">
                    <img title="lưu trữ" id="<?php if(Auth::user()){echo 'stockpost';} ?>" src="{{URL::asset('/images/utils/stocked.svg')}}" alt="profile Pic" height="40" width="40">             
                </button>
                @else
...
@if(count($series) >0)
 <div class="css-1t6umzq">
        ...
        <p class="css-1r0y2zt" style="padding-left: 10px!important">Bài viết cùng chuyên đề [ {{ $posts[0]['serie'] }} ]</p>
        <div class="css-">
            @foreach ($series as $serie)

            <div class="css-1w5fqid">
                <a href="/{{ $posts[0]['name'] }}/posts/{{ $serie->item }}" class="css-1okdvfi">{{ $serie->title }}</a>
