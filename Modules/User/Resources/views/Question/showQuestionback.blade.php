...
<!--             <div class="css-tubf1g">
                ...
                <button class=" css-1drc635" style="border:none">
                    <img id="stockpost" src="{{URL::asset('/images/utils/stocked.svg')}}" alt="profile Pic" height="40" width="40">             
                </button>
                @else
                <button class=" css-1drc635">
                ...
                <div class="css-1dtnjt5 e1y1ssrz6">
                    <div class="css-14u913p e1y1ssrz4">
                        <div class="css-3k83re e1y1ssrz8">
                            <!-- <div class="css-zrh2pa e1y1ssrz10">Q&amp;A</div> -->
                            <?php 
                            if ($posts[0]['type'] =="Q&A"){
    ...
    <!-- <div class="st-Modal is-open"> -->
        ...
        <div class="st-Modal_body css-tlvft">
            ...
            <div class="css-1elw6c9">
                ...
                <div class="css-dwc3sl" data-cateid= "<?php echo $user_category['id'];?>"><span class="fa fa-check-square css-7w3lkf"></span>{{$user_category['category_name']}}</div>
                @else
                <div class="css-dwc3sl" data-cateid= "<?php echo $user_category['id'];?>"><span class="fa fa-square css-imaq8p"></span>{{$user_category['category_name']}}</div>
                @endif
                @endforeach
            </div>    
