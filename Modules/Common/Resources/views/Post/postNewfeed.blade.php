...
@section('menu')
  <div class="st-NewHeader_mainNavigation">
    <div class="st-NewHeader_navigationTabContainer">
      ...
      @endauth
      <a class="st-NewHeader_mainNavigationItem is-active" href="/post">Bài viết</a>
...
<div class="st-NewHeader_subNavigation"><div class="st-NewHeader_subNavigationTabContainer">
	<a class="st-NewHeader_subNavigationItem is-active" href="/post">Mới nhất</a>	
	<a class="st-NewHeader_subNavigationItem" href="/post/trend">Nổi bật</a>
