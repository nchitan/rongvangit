...
$(document).ready(function () {
  ...
  if (Laravel.userId) {
    ...
    window.Echo["private"]("App.Models.User.".concat(Laravel.userId)).notification(function (notification) {
...
function routeNotification(notification) {
  ...
  if (notification.type === NOTIFICATION_TYPES.follow) {
    ...
    to = notification.data.following_name + "/posts/".concat(item) + to;
  }
...
function makeNotificationText(notification) {
  ...
  if (notification.type === NOTIFICATION_TYPES.follow) {
    ...
    text = '<a href="/' + temp.name + '">' + '<img class="css-qc85t4 eyfquo10" src="' + temp.profile_photo_url + '" width="32" height="32" size="32" loading="lazy">' + '</a>' + '</div>' + '<a href="/' + temp.name + to + '" class="css-1ovl61n">' + '<p class="css-1bz4scd">' + '<span class="bold">' + temp.fullname + '</span> đã theo dõi bạn.</span></p>' + '<time datetime="' + temp.created_at + '" class="css-hm64qx">' + temp.created_at + '</time></a>';
  } else if (notification.type === NOTIFICATION_TYPES.newPost) {
    var to = "?read=".concat(notification.id);
    var temp = "";
    ...
    if (temp.fullname == null) temp.fullname = temp.name;
    text = '<a href="/' + temp.name + '">' + '<img class="css-qc85t4 eyfquo10" src="' + temp.profile_photo_url + '" width="32" height="32" size="32" loading="lazy">' + '</a>' + '</div>' + '<a href="/' + temp.name + '/posts/' + temp.item + to + '" class="css-1ovl61n">' + '<p class="css-1bz4scd">' + '<span class="bold">' + temp.fullname + '</span> đã đăng bài viết:<span class="bold">「' + temp.title + '...」</span></p>' + '<time datetime="' + temp.created_at + '" class="css-hm64qx">' + temp.created_at + '</time></a>';
  }
...
;(function() {
  ...
  var runInContext = (function runInContext(context) {
    ...
    ListCache.prototype.has = listCach