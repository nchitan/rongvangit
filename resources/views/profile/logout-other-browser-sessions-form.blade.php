<x-jet-action-section>
    <x-slot name="title">
        {{ __('Nơi bạn đã đăng nhập') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Kiểm tra thiết bị bạn đã đăng nhập.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Nếu cần, bạn có thể đăng xuất khỏi tất cả các phiên trình duyệt khác trên tất cả các thiết bị của mình. Một số phiên gần đây của bạn được liệt kê bên dưới đây.') }}
        </div>
